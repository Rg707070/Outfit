...
function WeatherIcon({ description }: { description: string }) {
  ...
  if (d.includes('rain') || d.includes('drizzle') || d.includes('גשם')) return <CloudRain size={20} className="text-blue-400" />
  if (d.includes('snow') || d.includes('שלג')) return <Snowflake size={20} className="text-blue-200" />
  if (d.includes('wind') || d.includes('רוח')) return <Wind size={20} className="text-gray-400" />
  if (d.includes('cloud') || d.includes('ענן')) return <Cloud size={20} className="text-gray-400" />
