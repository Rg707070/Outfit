...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sliding panel — uses inline style to avoid Tailwind v4 RTL transform quirks */}
      <div
      ...
      <aside
        className="hidden md:flex fixed top-0 bottom-0 right-0 w-64 bg-white border-s border-gray-100 flex-col z-40"
      >
