...
export default function InsightsPage() {
  ...
  const statCards = [
    ...
    { label: t.insights.statWornTotal, value: history.length, icon: TrendingUp, bg: 'bg-green-50', fg: 'text-green-600', href: '/history' },
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          ...
          {categoryCounts.length === 0 ? (
            <div className="text-center py-6">
              <p className="text-gray-400 text-sm">{t.insights.noItemsYet}</p>
              ...
              {categoryCounts.map(cat => (
                <div key={cat.value}>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-sm text-gray-700">{cat.emoji} {t.categories[cat.value]}</span>
            ...
            <div>
                      ...
                      {week.map(day => {
                        ...
                        return (
                          <div
                            ...
                            title={`${format(day, 'dd/MM')}${isWorn ? ` · ${t.insights.wore}` : ''}`}
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-gray-400">{t.insights.wore}</span>
                </div>
              </div>
            </div>
          )}
        ...
        {sleepingItems.length > 0 && (
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border border-amber-100 p-6 lg:col-span-2">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full font-medium">{t.insights.wakeThemUp}</span>
            </div>
